...
class Atri:
	...
	def Image34(self, new_state):
		...
		global default_state
		self._Image34 = Image34Class(new_state, default_state["Image34"])
	...
	def TextBox28(self, new_state):
		...
		global default_state
		self._TextBox28 = TextBox28Class(new_state, default_state["TextBox28"])
	...
	def TextBox29(self, new_state):
		...
		global default_state
		self._TextBox29 = TextBox29Class(new_state, default_state["TextBox29"])
	...
	def Image35(self, new_state):
		...
		global default_state
		self._Image35 = Image35Class(new_state, default_state["Image35"])
	...
	def Image36(self, new_state):
		...
		global default_state
		self._Image36 = Image36Class(new_state, default_state["Image36"])
	...
	def TextBox30(self, new_state):
		...
		global default_state
		self._TextBox30 = TextBox30Class(new_state, default_state["TextBox30"])
	...
	def Flex61(self, new_state):
		...
		global default_state
		self._Flex61 = Flex61Class(new_state, default_state["Flex61"])
	...
	def Flex62(self, new_state):
		...
		global default_state
		self._Flex62 = Flex62Class(new_state, default_state["Flex62"])
	...
	def Flex63(self, new_state):
		...
		global default_state
		self._Flex63 = Flex63Class(new_state, default_state["Flex63"])
	...
	def Flex64(self, new_state):
		...
		global default_state
		self._Flex64 = Flex64Class(new_state, default_state["Flex64"])
	...
	def Flex65(self, new_state):
		...
		global default_state
		self._Flex65 = Flex65Class(new_state, default_state["Flex65"])
	...
	def TextBox31(self, new_state):
		...
		global default_state
		self._TextBox31 = TextBox31Class(new_state, default_state["TextBox31"])
	...
	def Flex66(self, new_state):
		...
		global default_state
		self._Flex66 = Flex66Class(new_state, default_state["Flex66"])
...
class Image34Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Image34ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Image34ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		...
		self._styles = Image34ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
	...
	def custom(self, state):
		...
		self._custom = Image34ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class TextBox28ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox28ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox28Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox28ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox28ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox28ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox28ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class TextBox29ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox29ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox29Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox29ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox29ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox29ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox29ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Image35Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Image35ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Image35ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Image35ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = Image35ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Image36Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Image36ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Image36ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Image36ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = Image36ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class TextBox30ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox30ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox30Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox30ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox30ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox30ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox30ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Flex61Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex61ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex61ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Flex62Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex62ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex62ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Flex63Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex63ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex63ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Flex64Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex64ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex64ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Flex65Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex65ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex65ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class TextBox31ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox31ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox31Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox31ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox31ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox31ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox31ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Flex66Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex66ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex66ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
